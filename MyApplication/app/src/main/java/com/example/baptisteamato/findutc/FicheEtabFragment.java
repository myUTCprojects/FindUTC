...
public class FicheEtabFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        /*-----------find Views-------------*/
        Button buttonVoirAvis = (Button) view.findViewById(R.id.voir_avis);
        Button buttonRedigerAvis = (Button) view.findViewById(R.id.rediger_avis);
        Button buttonVoirCarte = (Button) view.findViewById(R.id.voir_carte);
        ...
        TextView TextAdresse = (TextView) view.findViewById(R.id.textAdresse);
        final TextView TextPhone = (TextView) view.findViewById(R.id.textPhone);
        TextView TextHoraires = (TextView) view.findViewById(R.id.textHoraires);
        ...
        /*--------Appui long sur le numéro de téléphone : copie du numéro---------*/
        ...
        ImageView phone = (ImageView) view.findViewById(R.id.ic_phone);
